        ...
        <div class="col-12 text-center">
            <div id="carouselExampleIndicators" class="carousel slide">
                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center mt-md-2">
                          <div class="col-12 col-md-10">
                            <p class="homesec2-profdescription">
                ...
                <div class="carousel-indicators pt-md-5">
                    <button type="button" style="width: 10px;height: 10px; background-color: green" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                    <button type="button" style="width: 10px;height: 10px; background-color: green" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2"></button>
                    <button type="button" style="width: 10px;height: 10px; background-color: green" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3"></button>
                  </div>
              </div>
            </div>
        </div>
